...
then it will slow down and stop.
...
but friction is all around you.
...
Both always oppose motion.

When you pushed your book across the desk
...
To understand the other kind of friction
...
Once your force is greater than this maximum static friction
...
It may seem reasonable to think that the force of friction also might depend on either the surface area in contact or the speed of the motion

but experiments have shown that this is not true.

The normal force between the two objects does matter

however.

The harder one object is pushed against the other

the greater the force of friction that results.
...
Plotting the data will yield a graph like the one in Figure 5-10.

There is a direct proportion between the kinetic friction force and the normal force.
...
You would expect it to be much harder to pull the block along sandpaper than along a polished table
...
Remember that the static friction force acts in response to a force trying to cause a stationary object to start moving.

If there is no such force acting on an object

the static friction force is zero.

If there is a force trying to cause motion

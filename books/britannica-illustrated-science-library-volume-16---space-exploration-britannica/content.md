...
Icecap on the south pole of Mars.
...
All this is accompanied by photographs and top-quality illustrations
...
Every day astronomers are more convinced that there are other places in the universe that are like Earth.

We only have to find them.

They also assure us that this is one of the most interesting moments in the exploration of the solar system

because so many things are being revealed.

Orbiting spacecraft such as Mars Odyssey and Mars Express have confirmed the existence of ice under the surface of Mars.

Sending exploratory spacecraft to Saturn was another prodigious feat
...
This shows that the search has only begun.
...
The cosmonaut had practically no control over the apparatus

which was remotely controlled by Soviet engineers.

The next step was made by the United States with the arrival of astronauts on the Moon.
...
To date, 12 men have visited the Moon.
...
transmit their information to Earth using radio equipment.

The area of satellite coverage depends on the type of orbit.
...
The real work begins when the apparatus reaches its target.

The instruments are activated to gather data that are sent to Earth for analysis.

Mars Express begins its voyage toward Mars

which will last almost seven months.

The probe is monitored from Mission Control Center in Darmstadt
...
Space probes are automatic vehicles that can use the gravitational field of one planet to reach another.

Some only pass at a preset distance from the planet they are studying

others (orbiters) follow a route that places them in planetary orbit.

From there they can send smaller landing probes
...
also made technological contributions to the exploration of the Earth's orbit and the solar system.

The second only to NASA in its investment in space.

The first Canadian launch occurred in 1962 with the Alouette 1 satellite.

The most important work of the CSA is Radarsat
...
The Canadian agency also participated in the International Space Station (ISS) by providing the robot arm called the Mobile Service System (MSS).

To test different expansion models.

It will also seek to improve by the results from the U.

WMAP mission on the formation and evolution of the universe and the background cosmic radiation.

The Planck mission will have 10 times better resolution than WMAP.

The launch is planned for 2008 using an Ariane rocket.
...
The region is almost unpopulated and free from earthquakes.
...
**TOWARD THE ASSEMBLY FINAL DESIGN BUILDING LAUNCH PLATFORM**
...
it uses the technology and launching sites that it inherited from the Soviet space program.

The Russian agency was responsible for orbiting the Mir space station

the direct predecessor of the International Space Station.

Mir was assembled in orbit after separate launches of different modules between 1986 and 1996.

It was destroyed in a controlled manner at the end of its useful life on March 23
...
three independent organizations were combined to form the JAXA
...
He was the sole crew member of the Russian spacecraft Vostok 1.

Gagarin orbited the Earth in his capsule
...
The results from this mission were carried out to investigate the various matters related to systems development of the spacecraft were analyzed.

The spacecraft are still being used today
...
Gagarin was the first person to go into space.
...
which was controlled remotely by Soviet engineers.
...
which contained the rocket engine.
...
In 1975 he commanded the Apollo-Soyuz mission.

Voshkod 2 carried him to outer space.
...
First it crossed a part of Siberia and then the entire breadth of the Pacific Ocean

it passed between Cape Horn and Antarctica

and once it had crossed the Atlantic it flew in African skies over the Congo.
...
**SPUTNIK 2** On November 3 the second Soviet satellite was launched

with the dog Laika.

**EXPLORER 1** First American satellite to orbit the Earth.

It was launched in February.

**NASA** The National Aeronautics and Space Administration was founded in the United States.
...
**LITTLE DOGS** Strelka and Belka returned alive from a trip in orbit that lasted one day.
...
**MERCURY** NASA's Alan Shepard made a suborbital flight of 15 minutes.

**GEMINI 1** The first two Gemini were launched as unmanned flights in 1964 and 1965.

**VOSHKOD 1** A crew of three went into space for the first time.
...
Over the course of the space race between the Soviet Union and the United States
...
the American project sent three monkeys into space.
...
The six successful flights of the Mercury mission included a suborbital flight in May 1961
...
The first sentient beings in space were animals

sent in order to ensure that humans could survive spaceflight.

Ham, the first monkey to fly into space

survived life in space without problems.
...
This allowed it to obtain data from the surface.
...
and measuring the lunar magnetic and gravitational fields.

Through the intelligence and expertise of the astronauts onboard
...
A dozen men were able to walk on the gray
...
1928) was the backup commander for the Gemini 4 flight and command pilot of Gemini 7 and 12.

The only civilian on the Apollo mission was Harrison Schmitt (b.

1935).

The Apollo lunar module was the first spacecraft designed to fly in a vacuum without any aerodynamic capabilities.
...
The Apollo and the Soviet Soyuz docked in space in the first and historic joint mission between NASA and the Soviet Space Agency.
...
The spacecraft orbited the Moon and mapped its surface.

It was also used to obtain radar data on the unlit craters near the Moon's south pole.
...
Its purpose was to analyze unexplored regions and to test new technologies

such as solar ionic propulsion.
...
One of the most powerful telescopes that was put into orbit.

1989: COBE.

First results concerning the cosmology of the universe.

1986: MIR.

The first phase of the Russian space station Mir was successfully put into orbit.

1981: SPACE SHUTTLE.

The first manned mission was conducted with the shuttle Columbia.

1977: VOYAGER 1 AND 2.

Fly by Jupiter in 1979 and Saturn in 1980.

1976: VIKING.

Takes photos of the surface of Mars.

1973: SKYLAB.

The launching of the first American space station
...
Day 1: The first point in the sky.

Because it can focus on the sky in two directions simultaneously
...
Every six months it completely covers the entire sky
...
The latest results of WMAP show polarized temperature zones.
...
Engineers and medical doctors have investigated how humans can survive long periods where there is little gravity without causing the body to atrophy.
...
A spacecraft in orbit is essentially constantly falling around the Earth

and astronauts aboard do not feel the force of gravity even though they are being pulled by the Earth's gravity.
...
Other methods of training for the astronauts make use of a gigantic swimming pool in which an environment can be created to simulate working in microgravity.
...
This is the case with the spacecraft Cassini
...
because they are more accessible for the transport of the goods needed to build the launch vehicles.
...
Vehicle Assembly Building has a height of 189 feet (57.

6 m) and moves in a semicircular path around the shuttle.

The spaceport has an immense building for the preparation and assembly of rockets and of the external shuttle tank.
...
It has three arms that connect it to the shuttle.

A rocket is built on an assembly platform.

The rocket is transferred to the launching barge Odyssey.

The rocket is stored until launch.

The assembly barge leaves the location.
...
rockets are necessary for sending any kind of object into space.
...
the effect of gravity decreases.

Before liftoff, the fuel is ignited.
...
their fuel completely consumed.

The main engine remains attached until its fuel is used up

and it is then jettisoned.

Type of Rocket Depending on Its Combustion

Chemical rockets are the most common.
...
HYDROGEN ROCKETS REACTION burn fuel for two minutes.

The thrust of the rocket is the reaction resulting from the action of the hot exhaust escaping from the rocket.

LIQUID CHEMICAL NUCLEAR IONIC HELIUM THRUSTERS expel gases so that the rocket can begin its ascent.

MAIN ENGINE burns for 10 minutes.

ROCKET THRUST EARTH GRAVITY 1926 1942 1961 1969 1988 1999 On March 16

Robert Hutchings Goddard launched the first liquid-fueled rocket in the United States.

V2 rockets were being built by the Germans for military use.

They were the first rockets to be built on a large scale.
...
The rocket Saturn V sends a man to the Moon on the Apollo 11 mission.

The giant rocket is more than 330 feet (100 m) high.
...
After two failed attempts in 1996 and 1998

the Ariane 5 achieves its first successful commercial flight.
...
Preparations for launch begin with the assembly of the rocket
...
Once the atmosphere has been left behind
...
Booster rockets are typically used to produce greater initial thrust.

Final phase The work of the upper stage begins.

The upper-stage rocket is the only rocket not used on the launching pad.

Instead it is used to insert the payload into its proper orbit.

The rocket can be reignited after it is shut down and can burn for a total of 19 minutes.
...
The hot gases produced by the burning fuel push in all directions.

As the gases escape through the open nozzle

they generate an opposing force.
...
The main stage uses liquid hydrogen and oxygen.

The booster rockets are solid-fuel rockets.

Laser Gyroscope Fuel tank Electrical Signals Computer and Gas supply direction Gimbals Nozzle Inclination Nozzle Fairing The fairing is jettisoned when the air becomes so thin that wind no longer poses any danger to the payload.
...
Seven seconds later the two solid-fuel boosters are ignited.

Before the boosters' ignition, the flight can be aborted by shutting down the main stage.

Detachment The launch Explosive bolts separate the boosters countdown begins.

from the main stage and the main stage from the second stage.

The tanks begin to be filled.

Mechanical reinforcements are made.

The automatic launch sequence starts.

The main-stage engines are ignited.

The solid-fuel boosters are ignited.
...
Latitude of the Direction launching point of the Rockets must be rotation launched at predetermined times

which depend on the objective of the launch.

If the objective is to place a satellite into orbit

the latitude of the launched rocket needs to coincide with the trajectory of the desired orbit.

When the mission involves docking with another object in space

the launch window might fall within only a few minutes.

Ideal trajectory Comparison 218 feet (66 m) 200 feet 184 feet (56 m) 167 feet (51 m) 150 feet 363 feet (111 m) 100 feet 50 feet The height of the Saturn V

the largest rocket ever launched.

It was used in the late 1960s and early 1970s to take astronauts to the Moon.

During launching it could be heard 90 miles (150 km) away.

ARIANE 5 DELTA IV M+ SPACE SHUTTLE Solid-fuel boosters provide 90 percent of the initial thrust needed to launch the Ariane 5.
...
Later the booster rockets are retrieved by ships and refurbished.
...
The solid fuel is completely consumed.

The shuttle landing sequence is completely automatic and kicks in two minutes before returning to terra firma.

It lands on a runway 3 miles (5 km) long.

The cargo bay carries the apparatus that will be put into orbit.

The external tank houses the fuel and is jettisoned once in orbit.

The shuttle makes various "S" turns to reduce its velocity.

Once a day the Sun rises and sets every hour and a half when the shuttle is in orbit

but the astronauts attempt to sleep eight hours once a day.
...
They must bring the food to their mouths very carefully.

They must drink enough water or they could begin to suffer from dehydration.

The human body is accustomed to Earth's gravity.

In space the astronauts experience weightlessness

floating in the spacecraft.

Life in space can have undesirable effects on the body
...
The loss of mass can appear as an excess of calcium in other parts of the body (for example

kidney stones).

Because weightlessness causes muscle loss
...
They must also train physically to get used to low-gravity conditions in orbit and to be able to carry out repairs.

The training program is difficult and exhausting.

There are daily activities in the flight simulators with specialized computers.

Physical Training is the hardest part.

To habituate themselves to the microgravity of space
...
has an underwater model for preparatory training on Earth.
...
1965 - Edward White used this space suit to perform a space walk in the vicinity of the Gemini capsule.

1969 - The astronaut Neil Armstrong used this space suit when he became the first person to walk on the surface of the Moon.

1984 - Bruce McCandless wore this space suit when he performed the first historic space walk without being tethered to the shuttle.

1994 - Space shuttle astronauts use a much more modern and reusable space suit.

The helmet is treated to prevent fogging.

It contains the communication equipment and oxygen supply.

The exterior visor protects against the Sun.

The rescue sphere is to help the members of the crew who do not have space suits.

It is made of space-suit material and has its own oxygen supply.
...
the flight controllers carry out their tasks in front of consoles equipped with computers.

An enormous screen dominates the Operations Control Center.

It gives information on the location and orbital trajectory of a spacecraft in flight as well as other data.

The screen is of vital importance for the operators

because it allows for a rapid reading of information to take action efficiently and to prevent accidents.

The center was used for the first time in 1964 for the Gemini 4 mission.

The operations control room has an auditorium

a screen that projects the locations of tracking stations on the Earth

and another screen showing the passage of satellites in orbit.

Computers control all the components of the spacecraft.

The countdown before liftoff is performed and the flight plan made.

The second row checks and the astronauts' health and establishes communication with the crew.

The lead authorities are located in the fourth row

from where they coordinate the crew's activities.

The Operations Control Room consists of about a hundred consoles.
...
It is smaller than the Houston Center.

About 12 air controllers work there every day
...
Spacecraft maintenance is carried out 365 days a year.

The flight surgeon checks the medical condition of the crew.

The flight director helps the director of mission control.
...
Mars has often been seen as a goal for space exploration

perhaps because of its proximity to Earth and its relatively hospitable surface.
...
Desirable locations in geostationary orbits are already reaching this situation

chock-full of television and other radio transmissions.

The satellites transmit information in different frequencies depending on their function.
...
**C BAND** Used for television and GPS routing.

**Ka BAND** Offers higher speed and resolution.
...
makes it possible to provide coverage to the entire planet with only four satellites

whereas lower orbits need constellations of satellites to get total coverage.
...
* **ELLIPTIC ORBIT** APOGEE is the point farthest from the Earth.

PERIGEE is the point closest to the Earth.
...
There are two zones of concentrated particles
...
(FIVE YEARS WAS TO BE THE LIFETIME OF THE MISSION

BUT IT WAS SURPASSED.
...
This characteristic permits it to detect sources of light that are 20 times more diffuse.

The group in charge of constructing the X-ray telescope had to develop technologies for processes that had never been used before.

The satellite system provides the structure and the equipment necessary for the telescope and the scientific instruments to operate.

A propulsion system gradually puts the spacecraft into its final orbit

which is elliptical and extends far from Earth.

In order to control the critical temperature of its components

Chandra has a special system of radiators and thermostats.

The temperature near the X-ray mirrors has to be maintained at the proper temperature to keep the mirrors in focus.
...
**JET PROPULSION LABORATORY** receives information from the Deep Space Network and processes it.

**DEEP SPACE NETWORK** This international network of NASA radio antennas provides support for interplanetary missions in orbit around the Earth and for radio astronomy observations.

It consists of three complexes.
...
NASA launched the probe on Aug.
...
its life could be extended by another five years.
...
Once deployed, they turn on this axis.

The equipment obtains high-resolution images of the surface and permits predetermined mineral analysis.
...
POWERFUL INSTRUMENT MCS CRISM provides very high resolution images of large areas.

Helps to provide a context for the high-resolution images taken by HiRISE and CRISM.
...
two rockets are ignited to slow the fall.
...
were designed to travel over the surface of the Red Planet.

Both vehicles are part of NASA's Mars Exploration Rovers mission.

They have tools that allow them to drill into rock and take samples of the soil to analyze their chemical composition.

The robots are located on opposite sides of the planet to explore two uniquely different places.

They each use nine cameras.
...
Between ultraviolet radiation and the oxidative nature of the soil

life on Mars is not currently possible.

The question that remains is whether life might have existed at some time in the past or even today deep inside the Martian subsoil
...
Space stations have systems that provide oxygen to the crew and filter out the exhaled carbon dioxide.

Life in a space station allows astronomers to study the effect of a long-term stay in space.
...
Various countries have contributed modules for the station.
...
It is the first habitable compartment.
...
It provided energy in the first living and work area modules.

The structural and functional center of the ISS neutralizes the static electricity.

The structural module has a central section.

This is where scientific experiments in microgravity are performed.
...
The second starboard truss segment was added

and its solar panels were unfolded.

The radiators for dissipating the heat generated in the ISS allow communication with the Earth.

The ISS was entirely built and placed into orbit by the Russians.
...
which substantially decreases what might be seen in the heavens.

Space telescopes do not have to contend with light pollution
...
which then transmits the image or other observational data after the observation is completed.
...
It is an artificial satellite whose instruments are directed toward outer space.

The telescope can be remotely controlled by astronomers at different locations.
...
Orbital altitude: 370 miles (600 km)
...
Useful life: 20 years (until 2010)

Launch cost: $2 billion
...
The light enters through an aperture and is reflected in the primary mirror.

Then the light converges toward a secondary mirror.

The rays coming from the primary mirror go to the secondary mirror

which reflects the light and returns it to the primary mirror.

The rays go through a hole in the primary mirror and are then concentrated in the focal plane
...
The device was put in place by space shuttle astronauts in 1993.

SOHO: Put into orbit in 1995
...
It is expected to be deactivated in 2008.
...
Since the time that the first satellite (Sputnik) was launched in 1957

near space has become overcrowded with a large amount of debris.

Satellite batteries that have exploded and parts of rockets and spacecraft still orbiting the Earth form a genuine cosmic garbage dump.
...
NASA is studying rockets that do not get into orbit but fall to Earth to avoid generating more junk.

Any object launched from Earth that is no longer useful but is still orbiting the Earth is considered space junk.

Rockets used only once can remain in orbit

as do pieces of spacecraft or apparatuses ejected intentionally so that they would not enter the wrong orbit.

Space junk can even include lost objects.

In 1965 astronaut Edward White lost a glove
...
These are the objects that are cataloged and tracked from Earth.
...
The approximate number of objects currently in orbit
...
One course of action would be to ensure that the junk is returned to Earth and not allowed to orbit around it.

But the most that has been done is to remove satellite remains from Earth orbit.

The sail would be deployed when the satellite has stopped functioning.

Solar wind would push the satellite out of its orbit.

A cable drags the satellite to lower orbits
...
From the sightings by Galileo to the construction of space stations capable of sheltering humans
...
It is believed to be a frozen volcano.
...
The Galileo orbiter was in orbit for seven years

carrying out the most in-depth studies of its larger moons.

The atmosphere is in red.

The surface of the moon is in green and blue.
...
Perhaps for this reason it is the planet that has been most explored by various spacecraft from the decade of the 1960s onward

and it is therefore the one we know the best

apart from the Earth.

Mariner 9 in 1971 and Vikings 1 and 2 in 1976 revealed the existence of valleys and immense volcanic mountains.

In 2001 the United States launched the Mars Odyssey mission
...
It entered Martian orbit in October of the same year.

The Mars Odyssey was designed for a number of functions

such as taking images in the visible and infrared spectrum

studying the chemical composition of the planet's surface, and investigating the existence of possible sources of heat.
...
acting as a radio-signal repeater between Earth and probes on the Martian surface.
...
Weight: 1,600 pounds (725 kg)

Useful life: 10 years

The new observations of Mars made by the Odyssey suggest that the north pole has about one third more underground ice than the south pole.

Scientists also believe that microbial life could have developed on a planet other than Earth.
...
It weighs 7 pounds (3 kg) and consumes 7 watts.

It is supposed to measure radiation produced by the Sun or other stars and celestial bodies that reach the orbit of Mars.
...
The gamma-ray spectrometer's protective hood is opened.

The sensor begins to work.

The probe activates its auxiliary engines to adjust its trajectory.

The thrust lasts 23 seconds.
...
transmitting data about the atmosphere's chemical composition and Jupiter's meteorological activity.

The orbiter continued sending information until it crashed into the gaseous giant on Sept.

21, 2003.

In spite of its mission being plagued by technical problems
...
The probe contributed to the discovery of 21 new satellites around Jupiter.
...
It also showed an almost invisible ring around Jupiter consisting of meteorite dust.

From the moment it was launched until its disintegration
...
the atmospheric probe was provided with a deceleration module consisting of protective heat shields and thermal control hardware for the phases of the mission leading up to the entry into the atmosphere.

The probe descended into Jupiter's atmosphere.

of Jupiter, its Date of arrival Dec.
...
passing by Venus on Feb.

10, 1990.

Then it flew by the Earth twice and arrived at Jupiter on Dec.
...
The purpose of this termination was to avoid future collision with its moon Europa that might have contaminated its ice

scientists believe that extraterrestrial microscopic life may have evolved on Europa.
...
A parachute 8 feet (2.

5 m) in diameter was used to separate the descent module from the deceleration module and to control the velocity of the fall during the atmospheric descent phase.

The descent module carried instruments including 57 instruments.
...
ARRIVAL AT JUPITER DEC.

7, 1995

Galileo arrived at Jupiter and began the scientific studies that continued until 2003.

It completed 35 orbits around the planet.
...
The colors of the atmospheric clouds depend on their chemical composition.

The clouds spread with the violent turbulence of the atmospheric winds.

The descent module carried instruments.

Once Galileo arrived at the planet Jupiter

it released a small probe that fell through the atmosphere.

This descent probe carried scientific instruments and the subsystems required to keep them active and transmit the data to the orbiter for storage for later transmittal to Earth.

During its 57 minutes of active life in the Jovian atmosphere

the descent provided a number of discoveries
...
The areas in red consist of dirty ice formed by water mixed with rocky material that slowly seeped into the ice and once there began to freeze.
...
Galileo transmitted data from Venus.

IDA FLYBY AUG.

28, 1993

Galileo came close to the asteroid Ida.
...
The Huygens probe accomplished this prodigious feat

demonstrating once again the capacity of humans to respond to the challenge of frontiers.

The rings are a conglomerate of ice particles and powdered rock orbiting the planet.
...
Although it could only see a small section of Titan
...
which was flooded from time to time.

Investigators said that Titan could have very infrequent precipitation
...
although it is too cold for life to have started.
...
which are formed when sunlight breaks down atmospheric methane.

The thermometer measured –400° F (–203° C) at an altitude of 31 miles (50 km)
...
It is possible that many chemical compounds similar to those that preceded life on Earth exist in a frozen state at high altitudes.
...
Saturn Seen from the North Pole Orbit Equatorial Rotation
...
Spacecraft: The spacecraft TELESCOPES
...
The most important goal of the voyage is to visit Pluto

a dwarf planet (a designation made in 2006 by the International Astronomical Union).

The ship flew past Jupiter to gain enough speed to get to Pluto in the year 2015.

It will have six months to make observations of Pluto
...
All its systems and devices have backups.

The spacecraft carries a sophisticated guidance-and-control system for orientation.
...
Flyby Pluto: Cost $650 million

Weight: 1,025 pounds (465 kg)
...
New Horizons Mission is an unmanned space mission by NASA whose destination is to explore Pluto and the Kuiper belt.

The probe was launched from Cape Canaveral on Jan.
...
The principal objectives of the mission are to study the form and structure of Pluto and its satellite Charon

analyze the variability of the temperature on Pluto's surface, look for additional satellites around Pluto, and obtain high-resolution images.

The power source for the spacecraft is a radioisotope thermoelectric generator.

Radiometer measures the atmospheric composition and temperature.

Radioisotope generator provides energy for propulsion of the spacecraft.

Low-gain antenna auxiliary to the high-gain antenna

which it can replace in case of breakdown.

Thrusters the spacecraft carries six thrusters to increase its speed during flight.

Telescopic camera will map Pluto and gather high-quality geologic data.

Launch: Jan.

19, 2006.

The New Horizons probe is launched from Cape Canaveral toward Jupiter

Pluto, and the Kuiper belt.

Jupiter flyby: February 2007.

The probe flies by Jupiter to take advantage of the gravity of the planet on its journey toward Pluto.

Kuiper flyby: 2016-20.

The probe flies by one or more Kuiper belt objects.

The spacecraft New Horizons will arrive at Pluto on July 14

2015.

The Venus Express Mission Venus is a little smaller than the Earth and has a dense atmosphere.

Because it is located at slightly more than 67 million miles (108 million km) from the Sun

it receives almost twice the solar energy as the surface of the Earth.

The Venus Express is the first mission of the European Space Agency to Venus.
...
It was launched from the Baikonur cosmodrome on Nov.
...
The spacecraft entered into orbit on April 11

2006.

Spectrometer 1 measures the atmospheric temperature.

Spectrometer 2 operates on ultraviolet rays.

Solar panels capture the energy from the Sun that powers the mission.

Camera captures images in the ultraviolet.

Magnetometer measures magnetic fields and their direction.
...
The probe traverses the Martian orbit.

Arrival at Pluto: July 14, 2015.

New Horizons flies by Pluto and its moon Charon.
...
74 VISITING OTHER WORLDS SPACE EXPLORATION 75 Closer to the Sun.

The space probe Ulysses was launched from the space shuttle on Oct.

6, 1990.

It completed its first orbit around the Sun in 1997 and since then has carried out one of the most in-depth studies ever about our star.

The probe's orbits allow it to study the heliosphere at all latitudes, from the equator to the poles, in both the northern and southern hemispheres of the Sun.

The joint NASA and ESA mission is the first to orbit around the poles of the Sun.
...
Radial antenna a device that studies the gamma rays emitted by the Sun.

GRM an internal device to study the energy of the heliosphere's particles and cosmic dust.

VHM a device for studying the magnetic field of the heliosphere.

SWOOPS an instrument that studies the ionic composition of the solar wind and the particle material in the solar wind.
...
1992: Beginning of the first orbit.

1998: Beginning of the second orbit.

2004: Beginning of the third orbit.

Thanks to its intense nuclear activity the Sun expels a million tons of particles per second into space.

This particle flow forms a low-density plasma that extends the Sun's magnetic field and interacts with the Earth's magnetosphere.
...
HI-SCALE device designed to measure the energy present in ions and electrons of the interplanetary medium.
...
Bands of magnetic field generated by the bipolar characteristic of the Earth.
...
Antenna cable there is one on each side of the spacecraft.
...
Ulysses did not detect patterns in which wind speed corresponded with inclination

and in general the solar wind was slower and more variable.

Third orbit changes in the magnetic field

After having survived the difficult pounding of the solar activity during its second orbit

the Ulysses probe began a third orbit around the Sun's poles in February 2007.
...
2° with respect to the ecliptic.

Organization NASA and ESA (joint mission).

76 VISITING OTHER WORLDS SPACE EXPLORATION 77 The Road Beyond.

The space probes Voyager 1 and 2 were launched by NASA to study the outer solar system.

Voyager 1 was launched on Sept.

5, 1977

and flew by Jupiter in 1979 and Saturn in 1980.

Voyager 2 lifted off on Aug.

20, 1977

then flew by Jupiter and Saturn to reach Uranus in 1986 and Neptune in 1989.

Voyager 2 is the only probe that has visited both of these planets.

Both became the most distant artificial spacecraft instruments ever sent into space by humans.
...
Pioneer 11 stopped working in 1995.

Signals were received from Pioneer 10 until 2003.

The frontier of the solar system bow shock Voyager 1

Voyager 2.

Heliosphere.

Solar trajectory system.

The Voyager probe passed by Jupiter in 1979 and by Saturn in 1980.

The Voyager 2 did as well in 1986 and 1989.
...
Golden record the Voyagers carried the recorded greetings of humanity in a golden
...
the wife of the now-deceased astronomer Carl Sagan

who supervised this collection).
...
Binary code that marks the time.
...
Antenna must point in the exact direction.
...
beginning with the so-called "bow shock," a zone where the solar wind diminishes abruptly because of the disappearance of the solar magnetic field.

It is hoped that the Voyagers will continue to be active for at least 30 years.
...
Air purifiers are portable and can be carried from one room to another.
...
Polycarbonate spacecraft protection uses compacted polycarbonate layers with high resistance to impact

replacing glass and also used in eyeglasses.
...
Mamagoose pajamas are used to monitor infants when they are at home sleeping.
...
similar to systems used for astronauts.

Domestic uses include frequent space travel bringing new technologies to the home environment

such as microwave ovens and dehydrated food

which became part of daily routine.
...
Microwave ovens became popular in the United States in the 1970s

allowing rapid cooking or reheating of food using electromagnetic waves.

Barcode provides information via parallel lines that differ in thickness and spacing
...
The satellites are primarily in geosynchronous orbits

orbiting in the same time it takes Earth to rotate

allowing effective transmission systems because the satellite is stationary with respect to Earth's surface.
...
Connections can be established between any two points on Earth
...
Satellite communication includes telephone conversations and television data.

Iridium is a satellite-based mobile telephone system in low Earth orbit

consisting of 66 satellites in polar orbit.

Terrestrial stations house antennas and equipment for sending and receiving satellite signals

with antennas acting as receivers and transmitters of thousands of information streams.
...
This is the key for every signals and distribute them receives signals and kind of telecommunication.

transmits them to a center to different geographic that resends to them in the CENTER/ locations.
...
For telephone Groups of private Private clients Used for covering news cover a defined area when The signal arrives The voice signal goes can receive voice and communication corporations

such who pay for or events that occur in they arrive at Earth.

The area from the center via from the center to the images depending on between two points as TV networks satellite access different locations is known as a footprint.
...
The GPS be based on a constellation of 30 satellites (27 system

which uses a constellation of two dozen Navstar satellites

became fully operational in TECHNICAL SPECIFICATIONS

operational and 3 spares) in three medium Earth E P q la u n a e torial GALILEO SATELLITE orbits in different planes to ensure global coverage.

1995.

Although it began as a military initiative
...
A new development is the proposed variety of applications in addition to navigation

European Galileo satellite navigation system

which resembles the GPS system but would use a such as the management of taxi fleets in large cities (23

000 km) and the ability to locate stolen automobiles or other GALILEO ORBIT constellation of 30 satellites.

The European system is projected to become operational by 2013.

Orbital period 14 hours property.

The Galileo project arose in part to gain The orbit of the satellites Organization European Union independence from the GPS system

which could be ensures sufficient coverage interrupted or modified to be less accurate if Final number in orbit 30 (27 active) for calculating precise deemed necessary by the U.
...
m th a e g r n e e c t e ic iv w er a s v c e a s n s d i i g s n ta a n l
...
allows a common point to be and estimated time
...
intersection determined by the other three
...
These indicate to the observer all the desired coordinates.
...
S O O ne L A po R i n P t A s N ah E e L a S d places on the Earth at very high resolution.

Spot 5 can scan the Earth from three different angles

and the other backward from the which makes it possible to construct three-dimensional images.

Today Spot 5 is a commercial satellite par vertical axis of the satellite excellence
...
THREE-SATELLITE Using its scanning system
...
5 m), or they can be aimed at of any point on the globe.

different angles to produce stereoscopic images.
...
This is particularly valuable for applications that require images without clouds
...
Instrument for O O r r b b i i t t a a l l a p l e t r it io u d de 5 10 2 0 0 m m i i n le u s t e (8 s 32 km) 10 feet Landsat 7 was launched by NASA in 1 P O H ne A c S a E m 1 era 2 P N la H i t n e A e r t
...
the Spot Image programming teams make plans for JANUARY the satellites to take images over the next 24 hours to obtain the photographs that are on order.
...
In order to compare the observations of a given point taken on is the maximum different days
...
which means the plane of of the surface of the images.
...
600 sq km) geography of any region of the world in different scales

from images of 8 feet The maximum surface area attainable by SEA OF (2.
...
the path of the spacecraft is calculated and corrected using images of the stars taken by an onboard camera system
...
such as a series of on-off values.
...
Rockets carry their own oxidizer so that they burn fuel and provide propulsion in outer space
...
outside door that opens into space.
...
As the spacecraft passes through the atmosphere
...
The cells collect sunlight and convert it into electricity
...
Some probes are limited to the solar system
...
The term is used to refer to instruments that magnify an optical image or an image produced by other types of electromagnetic radiation
...
became aware of a mysterious type of radiation that had not been previously identified.
...
light composed of a single wavelength and in phase with each other.

Lasers can be built from a variety of substances (such as ruby and certain gases)

which are then stimulated electrically to produce a laser beam.

Laser beams can have many uses.

Intense beams can cut materials with great precision.

Laser light is also used for transmitting digital information
...
space probe that successfully landed on Mars on July 4
...
Given that radio waves travel at the velocity of light

the times involved can be very brief.
...
It includes such materials as big rocket fragments and small particles of paint.
...
The Soyuz replaced the Vostok in the mid-1970s.
...
The first astronaut to orbit the Earth—at an altitude of 195 miles (315 km)—was Yury Gagarin
...
It orbited the Earth for 21 days.
...
Many probes have been sent to land on the surface of a body of the solar system.

Such probes have been used to land on the Moon

Venus, Mars

and Saturn's moon Titan.

Spirit One of two robots—the other being Opportunity—that was launched in 2003 from Earth and that landed on Mars in 2004.

They carefully explored the surface of the planet.

Both vehicles are part of the NASA Mars Exploration Rovers mission.

They have tools that allow them to gather rocks and take soil samples to be analyzed for chemical and other composition.

The robots are located on opposite sides of the Red Planet so that they can photographically study very different places.

Space Shuttle The first spacecraft capable of returning to the Earth on its own and being reused on multiple missions.
...
The Challenger and Columbia were both destroyed in accidents (in 1986 and 2003

respectively).

Space Blanket Layer of powdered metal on a plastic film applied as spacecraft insulation or to reflect radio signals.

Blankets made of this material retain 80 percent of the body's heat.
...
Twelve astronauts have even landed on the Moon.

Space probes equipped with automatic instruments have visited many bodies of the solar system

including comets and asteroids as well as the planets and their moons.

Space Station A base designed to orbit the Earth for a long period of time.

Crew members can live and work in the space station for several months.

Space Suit A suit that allows the wearer to survive in space.

It protects against too much or too little heat and against the vacuum of space.
...
Its instrumentation sent back information about the upper atmosphere and the ionosphere.

Sputnik 2 carried the first living creature into space

the dog Laika.

Spacelab project was begun with a 1973 agreement between the United States and the nations belonging to the ESA.

The first flight occurred in November 1983.

The Spacelab was lifted into space for the last time in November 1997

when the development of the International Space Station began.

The original Soyuz series of spacecraft was developed between 1967 and 1981 and was used for 41 launches.

These capsules were replaced by the more modern Soyuz-T

launched 15 times between 1980 and 1986.

The most recent generation is the Soyuz-TM
...
They regularly work in flight simulators and receive training in the use of the spacecraft computers and other equipment.

Thermal Insulator Material that conducts heat poorly.

It is used to protect the walls of a rocket from the high temperatures produced by burning fuel and to protect the skin of a spacecraft from the heat produced by air friction during reentry into the atmosphere.

Reaction engine that carries its own fuel and source of oxygen so that it can function in space as well as in the atmosphere.

It is driven by the gases that exit from nozzles.

Launch vehicles consist of various rocket stages and can make use of booster rockets.
...
The most common type of rockets are chemical rockets

which may use liquid or solid fuels and oxidizers.

Satellite Object that orbits a much larger object.

Artificial satellites do not carry a crew.

They orbit the Earth and carry out such functions as the transmission of telephone calls or information about meteorology.

The International Space Station.

The first flight Material that conducts heat poorly.

It is used to protect the walls of a rocket from the high temperatures produced by burning fuel and to protect the skin of a spacecraft from the heat produced by air friction during reentry into the atmosphere.

Astronomy has been strongly influenced by Roentgen's discovery in spite of the fact that X-rays coming from celestial objects cannot penetrate the Earth's atmosphere.

Astronaut (cosmonaut) A person trained to travel in a spacecraft.

The terms "astronaut" and "cosmonaut" are used depending on the country of origin or the space agency.
...
Apollo spacecraft docked with a Soviet Soyuz capsule

and the crews conducted joint experiments.

Ariane 5 (rocket) A European heavy-lift launch vehicle.

It is used to send satellites into geostationary transfer orbit or other orbits.
...
His famous words upon stepping onto the lunar surface were
...
Ariane rocket, development, 14

Ames Research Center (NASA), 12

Alouette 1 (satellite), 15

alpha particle spectrometer, 23

animal retrieval system, 39
...
Apollo-Soyuz test project, 22, 23
...
Bumper (rocket stage), 11

Buran (space shuttle), 33
...
Mars Reconnaissance Orbiter, 53
...
Columbia (space shuttle), 9, 24, 36

commercial space flight, 90-91
...
transmission mechanism, 82-83

conventional navigation, 8

Cooper, Gordon, 18

cosmic background radiation, map, 24-25
...
solid-fuel rocket, 32, 37

types, 32, 33

engine, space shuttle, 37

environmental satellite, 86-87
...
European Space Agency (ESA), 14-15
...
Gemini 1 (spacecraft), 17

Gemini 3 (spacecraft), 18

Gemini 6 (spacecraft), 18

Gemini 7 (spacecraft), 18

Gemini 8 (spacecraft), 9

Gemini 10 (spacecraft), 18

geostationary orbit (GEO orbit), 48, 82

Global Positioning System (GPS), 84-85

orbit, 49

Glonass (satellite), 49
...
commercial space travel, 90-91

Automatic navigational system, 8-9

Trajectory, 70

Dwarf planet: See Pluto

Hubble space telescope repair, 29

Gravity (gravitation), 28-29

First module, 25

Cat's Eye nebula, 59

Floating launch platform, 31

Gravity boost for spacecraft, 25, 70
...
Mars Mössbauer spectrometer, 55

Redstone (rocket), 18

Io (moon of Jupiter), 69, 70
...
Relief photography, 87

Ion propellant, 33

Lagrange L2 (astronomy), 25

Earth view, 67

Need for exercise, 40

Pathfinder (probe), 25, 65

Rescue sphere, 43

Iridium (satellite), 49, 83

Laika (dog), 10, 11, 16

Exploratory missions, 4, 65
...
Israel, Spot 5 photography, 88

Landing, space shuttle, 39
...
Langley Research Center (NASA), 12
...
Operations centers, 44-45

New satellites discovered, 76

Propellants, 33

Japanese Space Agency (JAXA), 14, 15

Leonov, Aleksey, 16, 17, 23

Surface, 46-47, 67

Radio antenna: See Deep Space Network

Voyager 1 passing, 77

Soyuz, 15

Hayabusa mission, 15

Lewis Research Center (NASA), 12

Valles Marineris, 62-63
